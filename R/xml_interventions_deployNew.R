...
##' @param effects Either NULL or c("deterrency","preprandialKillingEffect","postprandialKillingEffect") for GVI, c("tag") for cumulative or subpop =T
